...
const greeting = {
  username: "Clariel Alfaro",
  title: "Hi there, I'm Clariel",
  subTitle: emoji(
    "A self-motivated web developer able to speak English and Spanish language 🚀 having an experience of building Web and Mobile applications with JavaScript / Android / C# / Java / Reactjs / Nodejs / other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1CEpumxlWzqEd4E3kWCX0ou0mX62MlH9D/view?usp=sharing", // Set to empty to hide the button
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Software Develpoment / Marketing",
      company: "Copy Delmy",
